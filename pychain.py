...
# Adding a function to clear input text if required by user
def clear_text():
...
sender_data = st.text_input("sender", key="text")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_data = st.text_input('receiver', key="text")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_data = st.text_input('amount', key="text")

Record = [sender_data,receiver_data,amount_data]
...
st.sidebar.image('Eth image10.jpg')
